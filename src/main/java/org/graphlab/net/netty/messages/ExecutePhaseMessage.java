...
/**
 */
public class ExecutePhaseMessage extends GraphLabMessage {
    ...
    public ExecutePhaseMessage(ExecutionPhase phase, int fromVertex, int toVertex) {
        super(MessageIds.EXECUTEPHASE);
        this.phase = phase;
